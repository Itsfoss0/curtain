...
const PasswordReset = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const token = new URLSearchParams(location.search).get('token');
      const response = await authService.resetPassword(token, id, { password: formData.password });
          ...
          <div className='text-center mb-6'>
            ...
            <div className='bg-gray-50 p-6 rounded-md text-left mb-6 border border-gray-200'>
              ...
              <ul className='list-disc pl-5 text-gray-700 space-y-2'>
                <li>Check if your reset link has expired (valid for 24 hours)</li>
                <li>
...
? 'text-yellow-600'
              ...
              <div className='mt-3 space-y-2'>
                <div className={`flex items-center ${passwordErrors.length ? 'text-red-500' : 'text-green-500'}`}>
                  ...
                  <span className='text-xs'>At least {minLength} characters</span>
                </div>
                <div className={`flex items-center ${passwordErrors.hasUpperCase ? 'text-red-500' : 'text-green-500'}`}>
                  <svg xmlns='http://www.w3.org/2000/svg' className='h-4 w-4 mr-2' fill='none' viewBox='0 0 24 24' stroke='currentColor'>
                ...
                <div className={`flex items-center ${passwordErrors.hasNumber ? 'text-red-500' : 'text-green-500'}`}>
                  <svg xmlns='http://www.w3.org/2000/svg' className='h-4 w-4 mr-2' fill='none' viewBox='0 0 24 24' stroke='currentColor'>
                ...
                <div className={`flex items-center ${passwordErrors.hasSpecialChar ? 'text-red-500' : 'text-green-500'}`}>
                  <svg xmlns='http://www.w3.org/2000/svg' className='h-4 w-4 mr-2' fill='none' viewBox='0 0 24 24' stroke='currentColor'>
            ...
            <div className='mb-8'>
              ...
              <div className='relative'>
                <input
                  ...
                  onChange={handleInputChange}
                  className={`w-full px-3 py-3 border ${
                    passwordErrors.match && formData.confirmPassword ? 'border-red-300' : 'border-gray-300'
                  } rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 pr-10`}
                  required
                />
                <button
            ...
            <div className='mb-4'>
              <button
                ...
                ${!formData.password || !formData.confirmPassword || passwordErrors.length || passwordErrors.match ? 'opacity-70 cursor-not-allowed' : ''}`}
                disabled={!formData.password || !formData.confirmPassword || passwordErrors.length || passwordErrors.match}
              >
                Reset Password
              </button>
            </div>
